...
export function TextsEditor() {
  ...
  return (
    <div className="space-y-6">
      <h2 className="text-2xl font-bold text-[#FAFAFA] mb-2">Personalização de Textos</h2>
      <p className="text-[#FAFAFA] mb-4">Altere o formato dos textos principais do sistema.</p>
      <Collapsible defaultOpen className="bg-[#000000] rounded-lg shadow-sm">
        <CollapsibleTrigger className="flex items-center w-full px-4 py-3 text-lg font-semibold text-[#009FCC] hover:bg-[#1F2E4F] rounded-t-lg transition cursor-pointer">
          <ChevronDown className="mr-2 h-5 w-5" /> Fonte Base
        </CollapsibleTrigger>
        <CollapsibleContent className="p-4 space-y-4">
          <div className="grid gap-4">
            ...
            />
            <span className="text-muted-foreground text-xs">Ex: Inter, Roboto, Open Sans. Certifique-se de que a fonte está disponível.</span>
          </div>
        </CollapsibleContent>
      </Collapsible>
      <Collapsible defaultOpen className="bg-[#000000] rounded-lg shadow-sm">
        <CollapsibleTrigger className="flex items-center w-full px-4 py-3 text-lg font-semibold text-[#009FCC] hover:bg-[#1F2E4F] rounded-t-lg transition cursor-pointer">
          <ChevronDown className="mr-2 h-5 w-5" /> Tamanhos e Altura de Linha
        </CollapsibleTrigger>
        <CollapsibleContent className="p-4 space-y-4">
          <div className="grid gap-4">
